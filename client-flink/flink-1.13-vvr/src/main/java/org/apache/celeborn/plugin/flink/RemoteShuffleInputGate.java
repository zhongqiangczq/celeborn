...
public class RemoteShuffleInputGate extends IndexedInputGate {
  ...
  public RemoteShuffleInputGate(
    ...
    inputGateDelegation =
        new RemoteShuffleInputGateDelegation(
            ...
            availabilityHelper,
            gateDescriptor.getConsumedSubpartitionIndexRange().f0,
            gateDescriptor.getConsumedSubpartitionIndexRange().f1);
  }
  ...
  private static class FakedMemorySegmentProvider implements MemorySegmentProvider {
    ...
    @Override
    public Collection<MemorySegment> requestMemorySegments(int i) throws IOException {
      return null;
    }

    @Override
    public void recycleMemorySegments(Collection<MemorySegment> collection) throws IOException {}
  }
