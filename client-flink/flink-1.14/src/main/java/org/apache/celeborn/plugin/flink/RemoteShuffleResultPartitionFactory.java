...
public class RemoteShuffleResultPartitionFactory {
  ...
  public RemoteShuffleResultPartitionFactory(
    ...
    long configuredMemorySize =
        celebornConf.getSizeAsBytes(celebornConf.memoryPerResultPartition());
    long minConfiguredMemorySize = celebornConf.getSizeAsBytes(minMemorySize);
    ...
    this.numBuffersPerPartition =
        CommonUtils.checkedDownCast(configuredMemorySize / networkBufferSize);
