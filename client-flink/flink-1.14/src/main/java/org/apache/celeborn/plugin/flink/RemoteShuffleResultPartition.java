...
import org.apache.celeborn.plugin.flink.transfer.PartitionSortedBuffer;
import org.apache.celeborn.plugin.flink.transfer.SortBuffer;
...
public class RemoteShuffleResultPartition extends ResultPartition {
  ...
  public void setup() throws IOException {
    ...
    try {
      ...
      CommonUtils.rethrowAsRuntimeException(throwable);
    }
  }
  ...
  private void writeCompressedBufferIfPossible(Buffer buffer, int targetSubpartition)
    ...
    try {
      if (canBeCompressed(buffer)) {
        ...
        compressedBuffer =
            CommonUtils.checkNotNull(bufferCompressor).compressToIntermediateBuffer(dataBuffer);
      }
  ...
  public void finish() throws IOException {
    CommonUtils.checkState(!isReleased(), "Result partition is already released.");
  ...
  public void flushAll() {
    try {
      ...
      CommonUtils.rethrowAsRuntimeException(t);
    }
  }
