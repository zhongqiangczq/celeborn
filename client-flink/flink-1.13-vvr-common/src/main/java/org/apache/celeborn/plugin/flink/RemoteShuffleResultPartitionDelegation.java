...
public class RemoteShuffleResultPartitionDelegation {
  ...
  private final Supplier<PartitionSortedBuffer> partitionSortedBufferFactory;
  ...
  public RemoteShuffleResultPartitionDelegation(
    ...
    this(networkBufferSize, outputGate, numBuffersOut, numBytesOut, numSubpartitions, null);
  }
  ...
  public RemoteShuffleResultPartitionDelegation(
      ...
      Counter numBytesOut,
      int numSubpartitions,
      Supplier<PartitionSortedBuffer> partitionSortedBufferFactory) {
    this.networkBufferSize = networkBufferSize;
    this.outputGate = outputGate;
    this.numBuffersOut = numBuffersOut;
    this.numBytesOut = numBytesOut;
    this.numSubpartitions = numSubpartitions;
    this.partitionSortedBufferFactory = partitionSortedBufferFactory;
  }
  ...
  public SortBuffer getUnicastSortBuffer() throws IOException {
    ...
    if (partitionSortedBufferFactory == null) {
      unicastSortBuffer =
          new PartitionSortedBuffer(bufferPool, numSubpartitions, networkBufferSize, null);
    } else {
      unicastSortBuffer = partitionSortedBufferFactory.get();
      ((PartitionSortedBuffer) unicastSortBuffer)
          .initilize(bufferPool, numSubpartitions, networkBufferSize, null);
    }
  ...
  public SortBuffer getBroadcastSortBuffer() throws IOException {
    ...
    if (partitionSortedBufferFactory == null) {
      ...
      broadcastSortBuffer = partitionSortedBufferFactory.get();
      ((PartitionSortedBuffer) broadcastSortBuffer)
          .initilize(bufferPool, numSubpartitions, networkBufferSize, null);
    }
