...
public class ShuffleResourceTrackerTest {
  ...
  public void testNotifyUnknownWorkers() {
    ...
    shuffleResourceTracker.registerJob(jobID1, (c) -> CompletableFuture.completedFuture(null));
    ...
    shuffleResourceTracker.registerJob(jobID2, (c) -> CompletableFuture.completedFuture(null));
